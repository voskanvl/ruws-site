...
function ProjectDetails({ data }: { data: ProjectsData }) {
    ...
    return (
        <>
            <Connector show={show} shiftX={shiftX} shiftY={shiftY} />
            <div
                ref={ref}
                className="panel"
                data-show={show}
                ...
                <div className="panel__container">
                    ...
                    <div className="panel__text">
                        ...
                        nulla, sed convallis nibh. Vestibulum vitae ipsum eget orci congue
                        tristique. Vivamus venenatis ex in nibh mollis.
                    </div>
